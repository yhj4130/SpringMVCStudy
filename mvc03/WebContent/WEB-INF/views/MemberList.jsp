...
<style type="text/css">
	* {line-height: 150%}
	#customerts td {text-align: center;}
	#submitBtn
	{
		height: 150%;
		width: 240px;
...
<div>
	<form action="memberinsert.action" method="post" id="memberForm">
		이름 <input type="text" name="name" id="name" class="control"><br>
		전화 <input type="text" name="telephone" id="telephone" class="control"><br>
	...
	<table id="customers" style="width: 500px;">
		...
		<c:forEach var="member" items="${memberList }">
			<tr>
				<%-- MemberDTO 객체의 getMid(), getName, getTelephone --%>
				<%-- 호출하는 EL 표현 --%>
				<td>${member.mid }</td>
				<td>${member.name }</td>
