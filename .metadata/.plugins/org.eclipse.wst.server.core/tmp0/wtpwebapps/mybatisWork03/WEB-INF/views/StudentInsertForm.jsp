			...
			<div class="panel-body">
				...
				<form action="studentinsert.action" method="post" id="studentForm">
					<table border="1">
						...
						<tr>
							<th>전화번호</th>
							<td><input type="text" id="tel" name="tel" maxlength="40">(40자 이내)</td>
						</tr>
						<tr>
							<td colspan="2" align="center">
								<br><br>
								<input type="submit" value="SUBMIT"class="btn btn-success btn-default"><span style="font-size: small">(*)는 필수입력 사항입니다.</span>
								<!-- <button type="button" class="btn" id="listBtn" style="width: 40%;" onclick="location.href='studentlist.action'">학생 리스트</button>  -->
								<br><br> 
								<span id="err" style="font-size: small; color: red; font-weight: bold; display: none;">필수입력 사항을 모두 입력해야 합니다.ㄴ</span>span>
							</td>
						</tr>
					</table>
				</form>
