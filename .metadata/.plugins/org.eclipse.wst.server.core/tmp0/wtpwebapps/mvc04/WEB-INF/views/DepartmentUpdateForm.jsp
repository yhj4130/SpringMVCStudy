	...
	<div id="content">
		...
		<form action="departmentupdate.action" method="post" id="departmentForm">
			<table>
				...
				<tr>
					<th>부서명</th>
					<td><input type="text" id="departmentName" name="departmentName" placeholder="부서명" value="${department.departmentName }"></td>
				</tr>
				<tr>
					<td colspan="2" align="center">
						<br><br>
						<button type="button" class="btn" id="submitBtn" style="width: 40%;">부서 수정</button>
