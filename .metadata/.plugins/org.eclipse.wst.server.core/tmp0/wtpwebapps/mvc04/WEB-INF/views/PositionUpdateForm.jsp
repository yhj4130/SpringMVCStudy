	...
	<div id="content">
		...
		<form action="positionupdate.action" method="post" id="positionForm">
			<table>
				...
				<tr>
					<th>직위명</th>
					<td><input type="text" id="positionName" name="positionName" placeholder="직위명" value="${position.positionName }"></td>
				</tr>
				<tr>
					<th>최소기본급</th>
				...
				<tr>
					<td colspan="2" align="center">
						<br><br>
						<button type="button" class="btn" id="submitBtn" style="width: 40%;">직위 수정</button>
